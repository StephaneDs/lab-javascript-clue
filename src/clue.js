...
let lastObject = pickMystery()
return `${lastObject.random[0].firstName} ${lastObject.random[0].lastName} killed Mr body using a ${lastObject.random[1].name} in the ${lastObject.random[2].name}`
